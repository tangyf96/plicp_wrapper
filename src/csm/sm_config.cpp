...
void set_params(sm_params* params, const sm_config* config)
{
    ...
    // params->icp_iteration_visible        = config->getParams<int>("icp_iteration_visible");
    // params->max_linear_velocity          = config->getParams<double>("max_linear_velocity");
    // params->max_angular_velocity         = config->getParams<double>("max_angular_velocity");
    // params->laser_frequency              = config->getParams<double>("laser_frequency");
    // params->min_valid_angle              = config->getParams<double>("min_valid_angle");
    // params->min_valid_distance           = config->getParams<double>("min_valid_distance");
    // params->corr_fail_perc               = config->getParams<double>("corr_fail_perc");
    // params->use_imu_yaw_as_absolute_rotation = config->getParams<int>("use_imu_yaw_as_absolute_rotation");
}
